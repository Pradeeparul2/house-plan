...
| `FF_Wall_Stair_North` | FF | North Facade / Staircase Spandrel | **$100.0\text{ mm}$** (4″) | $2095.5\text{ mm}$ | **$1370.4\text{ mm}$** | **$0.287\text{ m}^3$** | Flush with North boundary grid ($Y \in [0.0, 100.0\text{ mm}]$); anchors into C7 ($X = 1714.5$) and Toilet front ($X = 3810.0$); top datum $Z = 5457.8\text{ mm}$ |
