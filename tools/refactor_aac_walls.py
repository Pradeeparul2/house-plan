...
def refactor_aac_walls():
    ...
    wall_specs = [
        ...
        ("Wall_Stair_North", (2095.5, 200.0, 1065.6, 1714.5, 0.0, 914.4), []),
        ...
        ("Living_Room_Wall_Main_Door", (1514.5, 100.0, 2748.0, 200.0, 1714.5, 914.4), [
            (1050.0, 120.0, 2100.0, 446.55, 1704.5, 914.4), # D1 main entrance door
        ]),
        ("Wall_Stair_SE_SW", (2057.2, 100.0, 2748.0, 1714.5, 1714.5, 914.4), []),
        ...
        ("FF_Bedroom_Wall_South", (3048.0, 200.0, 3048.0, 1981.2, 7420.0, 4087.4), []),
        ("FF_Kitchen_Wall_South", (1981.2, 200.0, 3048.0, 0.0, 7420.0, 4087.4), []),
        ("FF_Bedroom_Wall_West", (200.0, 3048.0, 3048.0, 4829.2, 4572.0, 4087.4), []),
        ("FF_Living_Room_Wall_West", (200.0, 2857.5, 3048.0, 4829.2, 1714.5, 4087.4), []),
        ("FF_Toilet_Wall_West", (200.0, 1714.5, 3048.0, 4829.2, 0.0, 4087.4), []),
        ("FF_Kitchen_Wall_East", (200.0, 2438.4, 3048.0, 0.0, 5181.6, 4087.4), [
            (220.0, 914.4, 1219.2, -10.0, 5943.6, 5001.8), # W2 window
            (220.0, 250.0, 250.0, -10.0, 7000.0, 5912.4),   # Exhaust fan
        ]),
        ("FF_Living_Room_Wall_East", (200.0, 3467.1, 3048.0, 0.0, 1714.5, 4087.4), [
            (220.0, 1200.0, 1200.0, -10.0, 3510.0, 5001.8), # W1 window (Option 1 - South Bay clear of Col C4)
        ]),
        ("FF_Toilet_Wall_Front", (1219.2, 200.0, 3048.0, 3810.0, 0.0, 4087.4), []),

        # --- First Floor Inner Partitions (100 mm) ---
        ("FF_Bedroom_Wall_North", (3048.0, 100.0, 3048.0, 1981.2, 4526.0, 4087.4), [
            (914.4, 120.0, 2133.6, 3657.6, 4516.0, 4087.4), # D2 bedroom door
        ]),
        ("FF_Bedroom_Wall_East", (100.0, 3048.0, 3048.0, 1935.2, 4526.0, 4087.4), []),
        ("FF_Living_Room_Wall_Main_Door", (1514.5, 100.0, 3048.0, 200.0, 1714.5, 4087.4), [
            (1000.0, 120.0, 2100.0, 500.0, 1704.5, 4087.4), # FF Main Door
        ]),
        ("FF_Wall_Stair_SE_SW", (2057.2, 100.0, 3048.0, 1714.5, 1714.5, 4087.4), []),
        ...
        ("FF_Toilet_Wall_East_Top", (100.0, 1814.5, 914.4, 3771.7, 0.0, 6221.0), []),
    ]
    ...
    band_updates = [
        ...
        ("GF_Lintel_Main_Door", {"Length": 1514.5, "Width": 100.0, "Base": App.Vector(200.0, 1714.5, 3014.4)}),
        ("GF_Continuous_Lintel_Stair_South_Wall", {"Length": 2057.2, "Width": 100.0, "Base": App.Vector(1714.5, 1714.5, 3048.0)}),
